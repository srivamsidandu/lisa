...
class Build(subclasses.BaseClassWithRunbookMixin, InitializableMixin):
    ...
    def copy(self, source_path: str, files_map: List[FileSchema]) -> None:
            ...
            for file_map in files_map:
                ...
                for file in all_files:
                    if pattern.match(file):
                        ...
                        self._log.debug(
                            f"copy file {file} to {share_name}\\{file_name}"
                        )
